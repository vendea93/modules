...
<div class="modal fade" id="add_edit_template" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open('customemailandsmsnotifications/template/save',array('id'=>'custom-template-modal')); ?>
    ...
    window.addEventListener('load',function(){
       ...
       $('#add_edit_template').on('show.bs.modal', function(e) {
        ...
        if (typeof(group_id) !== 'undefined') {
            ...
            requestGetJSON('customemailandsmsnotifications/template/get_item_by_id/' + group_id).done(function (response) {
