...
function session_per_channel_pie_init(data_filter){
    ...
    $.post(site_url + 'google_analytic/google_analytic_client/get_data_analytics', data_filter).done(function(response){
...
function reloadMetrics() {
    ...
    $.post(site_url + 'google_analytic/google_analytic_client/get_metrics_list', data_filter).done(function(response){
