        ...
        <div class="row _buttons ">
          ...
          <div class="_hidden_inputs _filters _tasks_filters">
              <?php
                ...
                $google_accounts = ga_get_account_ids_by_base_workspace('google_analytic');
          ...
          <div class="col-md-4">
                <?php echo render_select('account_id',$google_accounts,array('id','name'),'property', '', array(), array(), '', '', false); ?>
          </div>
          <div class="col-md-4">
...
<!-- box loading -->
<?php init_tail(); ?>
<?php require('modules/google_analytic/assets/js/analytics/manage_js.php'); ?>
