 ...
 */
if (!function_exists('backup_resolve_backups_folder')) {
    function backup_resolve_backups_folder()
    {
        if (function_exists('perfex_saas_get_upload_path_by_type') && defined('PERFEX_SAAS_TENANT_UPLOAD_BASE_FOLDER')) {
            return perfex_saas_get_upload_path_by_type('module:backup');
        }

        return FCPATH . 'uploads/backups/';
    }
}

define('BACKUPS_FOLDER', backup_resolve_backups_folder());
