		...
		<div class="row">
			<div class="col-md-5">
				<h4 class="tw-mt-0 tw-font-semibold tw-text-lg tw-text-neutral-700">
					...
					<a href="<?php echo site_url('realestate/broker/list_invoices#' . $payment->invoiceid); ?>">
			...
			<div class="col-md-7">
				<div class="tw-flex tw-justify-between tw-mb-2.5">
					...
					<ul class="dropdown-menu dropdown-menu-right">
						<li class="hidden-xs">
							<a
							href="<?php echo site_url('realestate/broker/payment_pdf/' . $payment->paymentid . '?output_type=I'); ?>">
							<?php echo _l('view_pdf'); ?>
						</a>
					</li>
					<li class="hidden-xs">
						<a href="<?php echo site_url('realestate/broker/payment_pdf/' . $payment->paymentid . '?output_type=I'); ?>"
							target="_blank">
							<?php echo _l('view_pdf_in_new_window'); ?>
						</a>
					</li>
					<li>
						<a href="<?php echo site_url('realestate/broker/payment_pdf/' . $payment->paymentid); ?>">
							<?php echo _l('download'); ?>
						</a>
					</li>
					<li>
						<a href="<?php echo site_url('realestate/broker/payment_pdf/' . $payment->paymentid . '?print=true'); ?>"
							target="_blank">
							<?php echo _l('print'); ?>
						</a>
					</li>
				...
				<a href="<?php echo site_url('realestate/broker/delete_payment/' . $payment->paymentid.'/'.$payment->invoiceid); ?>"
					...
					<div class="col-md-6">
						<p class="tw-text-neutral-500"><?php echo _l('payment_date'); ?> <span
							...
							<span class="pull-right bold">
								<?php echo new_html_entity_decode($payment->name); ?>
						...
						<?php if (!empty($payment->transactionid)) { ?>
							...
							<p class="tw-text-neutral-500"><?php echo _l('payment_transaction_id'); ?>: <span
								class="pull-right bold"><?php echo new_html_entity_decode($payment->transactionid); ?></span></p>
							<?php } ?>
						</div>
...
<?php $this->load->view('brokers_portals/payments/send_to_client'); ?>
