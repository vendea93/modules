...
<div class="modal fade" id="renew_contract_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <?php echo form_open(site_url('realestate/broker/renew_contract'), ['id' => 'renew-contract-form']); ?>
...
<?php 
require 'modules/realestate/assets/js/brokers/contracts/renew_contract_js.php';
?>