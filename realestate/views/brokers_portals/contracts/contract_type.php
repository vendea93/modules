...
<div class="modal fade" id="type" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <?php echo form_open(site_url('realestate/broker/contract_type'), ['id' => 'contract-type-form']); ?>
...
<?php 
require 'modules/realestate/assets/js/brokers/contracts/contract_type_js.php';
?>