...
<div class="col-md-12 comment-item" data-commentid="<?php echo e($comment['id']); ?>">
    ...
    <?php if ($comment['broker_id'] != 0) { ?>
    <a href="<?php echo site_url('realestate/broker/profile'); ?>">
        <?php echo company_profile_image($comment['broker_id'], ['staff-profile-image-small',
        'media-object img-circle pull-left mright10',]); ?>
    </a>
    <?php } ?>
    <?php if ($comment['broker_id'] == get_business_broker_id()) { ?>
    ...
    <div class="media-body">
        <div class="mtop5">
            <?php if ($comment['broker_id'] != 0) { ?>
            <a href="#"><?php echo e(real_get_company_name($comment['broker_id'])); ?></a>
            <?php } else { ?>
