...
<div id="wrapper">
	<div class="content">
		<div class="row">
			<div class="col-md-12">
				<div class="_buttons">
						<a href="<?php echo site_url('realestate/broker/contract'); ?>"
							class="btn btn-primary pull-left display-block tw-mb-2 sm:tw-mb-4">
							<i class="fa-regular fa-plus tw-mr-1"></i>
							<?php echo _l('new_contract'); ?>
						</a>
					<?php $this->load->view('brokers_portals/contracts/filters'); ?>
					...
					<div class="tw-grid tw-grid-cols-2 md:tw-grid-cols-3 lg:tw-grid-cols-5 tw-gap-2">
						<div
						class="md:tw-border-r  md:tw-border-neutral-300 tw-flex-1 tw-flex tw-items-center">
					...
					<div
					class="tw-flex tw-items-center md:tw-border-r  tw-flex-1 md:tw-border-neutral-300 lg:tw-border-0">
					<span class="tw-font-semibold sm:tw-w-auto tw-mr-3 rtl:tw-ml-3 tw-text-lg">
			...
			<div class="panel-body">
				<div class="row ">
					...
					<div class="col-md-6 border-right">
						...
						<div class="relative tw-max-h-[500px]">
					...
					<div class="panel-table-full tw-mt-10">
						<?php $this->load->view('brokers_portals/contracts/table_html'); ?>
					</div>
				</div>
			</div>
		</div>
...
<?php 
require 'modules/realestate/assets/js/brokers/contracts/manage_js.php';
?>
</body>
