...
<div class="table-responsive">
    <table class="table table-hover no-mtop">
        ...
        <tbody>
            ...
            <tr class="payment">
                <td><?php echo new_html_entity_decode($payment['paymentid']); ?>
                    <?php echo icon_btn('realestate/broker/payment_pdf/' . $payment['paymentid'], 'fa-regular fa-file-pdf', 'btn-default pull-right'); ?>
                </td>
                <td><?php echo new_html_entity_decode($payment['name']); ?>
    ...
    echo ' - ' . $payment['paymentmethod'];
                ...
                <td>
                    <div class="tw-flex tw-items-center tw-space-x-3">
                        <a href="<?php echo site_url('realestate/broker/payment/' . $payment['paymentid']); ?>"
