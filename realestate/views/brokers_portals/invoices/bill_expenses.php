...
<div class="checkbox checkbox-primary invoice_inc_expense_additional_info">
    <input type="checkbox" id="inc_note" data-id="<?php echo new_html_entity_decode($expense['id']); ?>"
        data-content="<?php echo new_html_entity_decode($expense['note']); ?>">
...
<div class="checkbox checkbox-primary invoice_inc_expense_additional_info">
    <input type="checkbox" id="inc_name" data-id="<?php echo new_html_entity_decode($expense['id']); ?>"
        data-content="<?php echo new_html_entity_decode($expense['expense_name']); ?>">
...
<div class="checkbox">
    <input type="checkbox" name="bill_expenses[]" value="<?php echo new_html_entity_decode($expense['id']); ?>" data-toggle="popover"
        data-html="true" data-content="<?php echo new_html_entity_decode($additional_action; ?>") data-placement="bottom">
    <label for=""><a href="<?php echo admin_url('expenses/list_expenses/' . $expense['id']); ?>"
            target="_blank"><?php echo new_html_entity_decode($expense['category_name']); ?>
            <?php if (!empty($expense['expense_name'])) {
