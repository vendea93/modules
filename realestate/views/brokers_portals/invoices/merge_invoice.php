...
<div class="mergeable-invoices">
    ...
    <div class="checkbox">
        <input type="checkbox" name="invoices_to_merge[]" value="<?php echo new_html_entity_decode($_inv->id); ?>">
        <label for="">
            <a href="<?php echo site_url('realestate/broker/list_invoices/' . $_inv->id); ?>" data-toggle="tooltip"
