...
<?php echo form_open(site_url('realestate/broker/record_payment'), ['id' => 'record_payment_form']); ?>
    ...
    <div class="panel_s">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select class="selectpicker" name="paymentmode" data-width="100%"
                            ...
                            if (is_payment_mode_allowed_for_invoice($mode['id'], $invoice->id)) {
                                $totalAllowed++; ?>
                            <option value="<?php echo new_html_entity_decode($mode['id']); ?>"><?php echo new_html_entity_decode($mode['name']); ?></option>
                            <?php
                            } ?>
                            <?php } ?>
                        </select>
                    ...
                    <div class="alert alert-info">
                        ...
                        Click <a
                            href="<?php echo site_url('realestate/broker/invoice/' . $invoice->id . '?allowed_payment_modes=1'); ?>">here</a>
        ...
        <div class="panel-footer text-right">
            <a href="#" class="btn btn-danger"
                onclick="init_invoice(<?php echo new_html_entity_decode($invoice->id); ?>); return false;"><?php echo _l('cancel'); ?></a>
