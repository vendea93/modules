...
array_push($where, 'AND ' . db_prefix() . 'invoices.broker_id=' . get_business_broker_id());
...
foreach ($rResult as $aRow) {
    ...
    if (is_numeric($clientid) || $project_id) {
        $numberOutput = '<a href="' . site_url('realestate/broker/list_invoices/' . $aRow['id']) . '" target="_blank">' . format_invoice_number($aRow['id']) . '</a>';
    } else {
        $numberOutput = '<a href="' . site_url('realestate/broker/list_invoices/' . $aRow['id']) . '" onclick="init_invoice(' . $aRow['id'] . '); return false;">' . format_invoice_number($aRow['id']) . '</a>';
    }
    ...
    $numberOutput .= ' | <a href="' . site_url('realestate/broker/invoice/' . $aRow['id']) . '">' . _l('edit') . '</a>';
    $numberOutput .= '</div>';
