			...
			<table class="table dt-table table-invoices" data-order-col="1" data-order-type="desc">
				<thead>
					<tr>
						...
						<th class="th-invoice-number"><?php echo _l('real_term'); ?></th>
				...
				<tbody>
					<?php foreach($requests as $request){ ?>
						...
						<tr>
							...
							<td data-order="<?php echo new_html_entity_decode($request['term_month']); ?>" class=""><?php echo html_entity_decode(($request['term_month']).$rental_type_s); ?></td>
