...
$result = data_tables_init($aColumns, $sIndexColumn, $sTable, $join, $where, ['id', 'related_id', 'company_id', 'latitude', 'longitude', 'property_style','primary_image', 'rate','related_type']);
