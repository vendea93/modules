...
<?php if(isset($construction_company)){ ?>
	...
	$table_data = array_merge($table_data, array(_l('client_email'),_l('client_phonenumber'),_l('clients_list_last_login'),_l('contact_active')));
	echo render_datatable($table_data,'broker_staff_table'); ?>
<?php } ?>
