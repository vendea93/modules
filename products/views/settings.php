...
<div class="col-md-4">
	<i class="fa fa-question-circle pull-left" style="margin-right: 8px;" data-toggle="tooltip" data-title="<?php echo _l('product_low_quantity_tooltip'); ?>"></i>
...
<div class="col-md-4">
	<i class="fa fa-question-circle pull-left" style="margin-right: 8px;" data-toggle="tooltip" data-title="<?php echo _l('flat_shipping_tooltip'); ?>"></i>
...
<div class="col-md-4">
	<i class="fa fa-question-circle pull-left" style="margin-right: 8px;" data-toggle="tooltip" data-title="<?php echo _l('tax_for_shipping_cost_tooltip'); ?>"></i>
