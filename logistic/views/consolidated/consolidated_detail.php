                            ...
                            <div class="col-md-6">
                                <div class="btn-group pull-right mright5">
                                     ...
                                     <ul class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <li>
                                            <a href="javascript:void(0);" class="consolidation-send-to-client delete-text"><i class="fa fa-envelope"></i> <?php echo _l('lg_send_mail'); ?></a>
                                        </li>

                                      

                                        <li>
                                           <a href="<?php echo admin_url('logistic/export_consolidation_shipment/'.$consolidation->id.'?output_type=I'); ?>" class=" delete-text" target="_blank"><i class="fa fa-file-lines"></i> <?php echo _l('lg_export_shipment'); ?></a>
                                        </li>

                                        <li>
                                           <a href="<?php echo admin_url('logistic/export_consolidation_label/'.$consolidation->id.'?output_type=I'); ?>" target="_blank" class=" delete-text"><i class="fa fa-file-contract"></i> <?php echo _l('lg_export_label'); ?></a>
                                        </li>

                                        <?php if(has_permission('lg_consolidated','','edit')){ ?>
                                        <li>
                                           <a href="javascript:void(0);" onclick="assign_driver(this); return false;" data-consolidation_id="<?php echo e($consolidation->id); ?>" data-assign_driver="<?php echo e($consolidation->assign_driver); ?>" class="delete-text"><i class="fa fa-user"></i> <?php echo _l('lg_assign_driver'); ?></a>
                                        </li>
                                        <?php } ?>


                                        <?php if(has_permission('lg_consolidated','','edit') && !isset($delivery_shipments->id)){ ?>
                                        <li>
                                           <a href="<?php echo admin_url('logistic/consolidation_shipment_tracking/'.$consolidation->id); ?>" class=" delete-text"><i class="fa fa-truck"></i> <?php echo _l('lg_shipment_tracking'); ?></a>
                                        </li>
                                        <?php } ?>
                                        ...
                                        <?php if(has_permission('lg_consolidated','','edit') && !isset($delivery_shipments->id)){ ?>
                                        <li>
                                           <a href="<?php echo admin_url('logistic/consolidation_create_delivery_shipment/'.$consolidation->id); ?>" class=" delete-text"><i class="fa fa-truck"></i> <?php echo _l('lg_delivery_shipment'); ?></a>
                                        </li>
                                        <?php } ?>
                                     
                                        <?php if(has_permission('lg_consolidated','','edit') && !is_driver_staff()){ ?>
                                        <li>
                                           <a href="<?php echo admin_url('logistic/consolidation/'.$consolidation->id); ?>" class=" delete-text"><i class="fa fa-pencil"></i> <?php echo _l('edit'); ?></a>
                                        </li>
                                        <?php } ?>


                                        <?php if(has_permission('lg_consolidated','','delete') && !is_driver_staff()){ ?>
                                        <li>
                                           <a href="<?php echo admin_url('logistic/delete_consolidation/'.$consolidation->id); ?>" class="text-danger delete-text _delete"><i class="fa fa-trash"></i> <?php echo _l('lg_delete'); ?></a>
                                        </li>
                                        <?php } ?>
...
<?php $this->load->view('consolidated/consolidated_send_to_client'); ?>
<?php init_tail(); ?>


<?php require 'modules/logistic/assets/js/consolidated/consolidated_detail_js.php';?>