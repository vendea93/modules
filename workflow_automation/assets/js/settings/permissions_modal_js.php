...
<script>
	$(function() {
		...
		$('select[name="role"]').on('change', function() {
           var roleid = $(this).val();
           workflow_init_roles_permissions(roleid, true);
       	});

       	// Called when editing member profile
		function workflow_init_roles_permissions(roleid, user_changed) {
    	'use strict';
    	...
    	'use strict';
           	...
           	if(staff_id){
    			...
    			$('#additional_staff_permissions').append(hidden_input('id',staff_id));
           		...
           		requestGetJSON('workflow_automation/staff_id_changed/' + staff_id).done(function(response) {
