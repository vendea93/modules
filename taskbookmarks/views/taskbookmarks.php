            ...
            <div class="panel_s">
               <div class="panel-body">
                  <div class="row">
                   ...
                   <div class="_buttons">
                        <a href="#" onclick="new_taskbookmarks(); return false;" class="btn btn-info pull-left display-block">
                            <?php echo htmlspecialchars(_l('new_taskbookmarks')); ?>
                        </a>
                    </div>
                   <br><br><br>
...
<div class="modal fade" id="taskbookmarks" tabindex="-1" role="dialog"  >
    <div class="modal-dialog">
        <?php echo form_open(admin_url('taskbookmarks/taskbookmark'),array('id'=>'taskbookmarks-form')); ?>
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">
                    <span class="edit-title"><?php echo htmlspecialchars(_l('edit_taskbookmarks')); ?></span>
                    <span class="add-title"><?php echo htmlspecialchars(_l('new_taskbookmarks')); ?></span>
                </h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <?php echo render_input('taskbookmarks_name','taskbookmarks_name'); ?>
                    </div>
                    <div class="col-md-6">
