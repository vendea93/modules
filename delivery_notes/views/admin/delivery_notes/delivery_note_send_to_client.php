...
<div class="modal fade email-template" data-editor-id=".<?php echo 'tinymce-' . $delivery_note->id; ?>"
    id="delivery_note_send_to_client_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
