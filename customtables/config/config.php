...
$config['get_allowed_table'] = "f385794bcf119b1d1ee6aa0d44c43c2ef21ddacb";
$config['get_allowed_cols'] = "be62d1a4125654c7bff0572c88e35556ed99bfdf";
$config['get_allowed_colors'] = "";
$config['get_allowed_fields'] = "";
...
$config['tasks_columns'] = [
    ...
    [
        ...
        'column' => '(SELECT GROUP_CONCAT(CONCAT(firstname, \' \', lastname)  ORDER BY ' . db_prefix() . 'task_assigned.id ASC SEPARATOR \',\') FROM ' . db_prefix() . 'task_assigned JOIN ' . db_prefix() . 'staff ON ' . db_prefix() . 'staff.staffid = ' . db_prefix() . 'task_assigned.staffid WHERE taskid = ' . db_prefix() . 'tasks.id) as assignees',
