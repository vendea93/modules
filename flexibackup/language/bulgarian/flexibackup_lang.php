...
$lang[$key.'_auto_delete_remote_backups'] = "Автоматично изтриване на отдалечени резервни копия след успешно качване";
$lang[$key.'_note'] = "Забележка";
$lang[$key.'_retain_for_days_label'] = "Задаване на периода на съхранение на архива в дни (оставете празно, за да деактивирате)";
