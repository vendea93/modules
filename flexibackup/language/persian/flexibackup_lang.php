...
$lang[$key.'_auto_delete_remote_backups'] = "حذف خودکار پشتیبان گیری های از راه دور پس از آپلود موفق";
$lang[$key.'_note'] = "توجه داشته باشید";
$lang[$key.'_retain_for_days_label'] = "دوره نگهداری نسخه پشتیبان را بر حسب روز تنظیم کنید (برای غیرفعال کردن، خالی بگذارید)";
