...
$lang[$key.'_auto_delete_remote_backups'] = "Αυτόματη διαγραφή απομακρυσμένων αντιγράφων ασφαλείας μετά την επιτυχή μεταφόρτωση";
$lang[$key.'_note'] = "Σημείωση";
$lang[$key.'_retain_for_days_label'] = "Ορίστε την περίοδο διατήρησης αντιγράφων ασφαλείας σε ημέρες (αφήστε κενό για απενεργοποίηση)";
