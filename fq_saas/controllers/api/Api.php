...
class Api extends \ClientsController
{
    ...
    public function __construct()
    {
        ...
        defined('FQ_SAAS_API') or define('FQ_SAAS_API', true);
    }
    ...
    public function docs($method = '')
    {
        ...
        if (!is_admin()) {
            if (get_option('fq_saas_api_allow_public_access_to_doc') != '1') {
        ...
        $apiKey = is_logged_in() && is_admin() ? get_option('fq_saas_api_key') : '';
