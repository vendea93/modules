    ...
    <?php else : ?>
        <div class="btn-group">
            ...
            <ul class="dropdown-menu dropdown-menu-right">
                <li><a onclick="return confirm('<?= fq_saas_ecape_js_attr(_l('fq_saas_pricing_cancel_confirmation')); ?>')" href="<?php echo base_url('clients/my_account/cancel_subscription?type=immediately'); ?>">
                        <?php echo _l('cancel_immediately'); ?></a></li>
                <li><a onclick="return confirm('<?= fq_saas_ecape_js_attr(_l('fq_saas_pricing_cancel_confirmation')); ?>')" href="<?php echo base_url('clients/my_account/cancel_subscription?type=at_period_end'); ?>">
