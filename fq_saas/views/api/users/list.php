...
<table class="apitable table dt-table">
    <thead>
        ...
        <th><?php echo _l('fq_saas_api_key'); ?></th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?= e($user->token); ?></td>
            <td>
                <a href="<?= admin_url(FQ_SAAS_ROUTE_NAME . '/api/edit_user/' . (int)$user->id) ?>"
                    class="btn btn-default btn-icon"><i class="fa fa-pencil"></i></a>
                <a href="<?= admin_url(FQ_SAAS_ROUTE_NAME . '/api/delete_user/' . (int)$user->id); ?>"
