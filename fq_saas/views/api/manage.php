        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="_buttons">
                            <h4 class="pull-left"><?= _l('fq_saas_api_documentation'); ?></h4>
                            <a href="<?php echo admin_url('settings?group=' . FQ_SAAS_MODULE_WHITELABEL_NAME . '&tab=api'); ?>"
                                class="btn btn-default pull-right"><i class="fa fa-cog"></i>
                                <?php echo _l('fq_saas_settings'); ?></a>
                        </div>
                        <div class="clearfix"></div>
                        <hr />
                        <div class="clearfix"></div>
                        <?php $apiDocLink = base_url(FQ_SAAS_ROUTE_NAME . '/api/docs'); ?>
                        <p class="mtop20">
            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="_buttons">
                            <h4 class="pull-left"><?= _l('fq_saas_api_user'); ?></h4>
                            <a href="<?php echo admin_url(FQ_SAAS_ROUTE_NAME . '/api/create_user') ?>"
