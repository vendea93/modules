    ...
    <div class="horizontal-tabs">
        <ul class="nav nav-tabs nav-tabs-horizontal" role="tablist">
            ...
            $tabs = [
                ...
                ['id' => 'tenants_seed', 'label' => _l('fq_saas_tenants_seed')],
                ['id' => 'modules', 'label' => _l('fq_saas_settings_modules')],
                ['id' => 'services', 'label' => _l('fq_saas_settings_services')],
                ['id' => 'integrations', 'label' => _l('fq_saas_settings_integrations')],
                ['id' => 'api', 'label' => _l('fq_saas_api')],
                ['id' => 'miscellaneous', 'label' => _l('fq_saas_settings_miscellaneous')],
            ];
