...
<div class="tw-flex tw-items-start tw-mt-4 tw-justify-center">
    <div class="tw-flex tw-space-x-2 pool-template tw-items-center" id="single-pool-template">
        <?php echo render_input('db_pools[host]', 'fq_saas_db_host', $_dsn['host'] ?? '', 'text', ['placeholder' => 'localhost']); ?>
        <?php echo render_input('db_pools[user]', 'fq_saas_db_user', $_dsn['user'] ?? '', 'text', ['placeholder' => 'root']); ?>
        <?php echo render_input('db_pools[password]', 'fq_saas_db_password', $_dsn['password'] ?? '', 'text', ['placeholder' => 'password']); ?>
        <?php echo render_input('db_pools[dbname]', 'fq_saas_db_name', $_dsn['dbname'] ?? ''); ?>
        <div>
