...
$total_packages = $CI->db->count_all_results(fq_saas_table('packages'));
$total_companies = $CI->db->count_all_results(fq_saas_table('companies'));
$total_subscriptions = $CI->db->where(fq_saas_column('packageid') . ' >', 0)->count_all_results(db_prefix() . 'invoices');
$invoices_total = $CI->fq_saas_model->get_invoices_total([]);
...
<div class="widget relative tw-mb-8" id="widget-saas_top_stats" data-name="<?= _l('fq_saas_dashboard_statistic'); ?>">
    <div class="panel_s">
        <div class="panel-body padding-10">
            ...
            <p class="tw-font-medium tw-flex tw-items-center tw-mb-0 tw-space-x-1.5 rtl:tw-space-x-reverse tw-p-1.5">
                ...
                <span class="tw-text-neutral-700">
                    <?= _l('fq_saas_dashboard_statistic'); ?>
                </span>
            </p>
            ...
            <div class="row tw-flex tw-flex-wrap tw-justify-center">
                ...
                <div class="col-md-5 tw-flex tw-flex-wrap">
                    <div class="col-xs-12 col-md-6 tw-mb-2">
                        <div class="top_stats_wrapper">
                            <div class="tw-text-neutral-800 mtop5 tw-flex tw-items-center tw-justify-between">
                                <div class="tw-font-medium tw-inline-flex text-neutral-600 tw-items-center"> <i class="fa fa-university tw-mr-2"></i> <?= _l('fq_saas_companies'); ?>
                                </div>
                    ...
                    <div class="col-xs-12 col-md-6 tw-mb-2">
                        <div class="top_stats_wrapper">
                            <div class="tw-text-neutral-800 mtop5 tw-flex tw-items-center tw-justify-between">
                                <div class="tw-font-medium tw-inline-flex text-neutral-600 tw-items-center mr-2"> <i class="fa fa-list tw-mr-2"></i> <?= _l('fq_saas_packages'); ?>
                                </div>
                        ...
                        <div class="top_stats_wrapper">
                            <div class="tw-text-neutral-800 mtop5 tw-flex tw-items-center tw-justify-between">
                                <div class="tw-font-medium tw-inline-flex text-neutral-600 tw-items-center mr-2">
                                    <?= $money_icon; ?>
                                    <span class="tw-ml-1"><?= _l('fq_saas_total_revenue_overdue'); ?></span>
                                </div>
                    ...
                    <div class="col-xs-12 col-md-6 tw-mb-2">
                        <div class="top_stats_wrapper">
                            <div class="tw-text-neutral-800 mtop5 tw-flex tw-items-center tw-justify-between">
                                <div class="tw-font-medium tw-inline-flex text-neutral-600 tw-items-center mr-2">
                                    <?= $money_icon; ?>
                                    <span class="tw-ml-1"><?= _l('fq_saas_total_revenue_due'); ?></span>
                                </div>
                    ...
                    <div class="col-xs-12 col-md-6 tw-mb-2">
                        <div class="top_stats_wrapper">
                            <div class="tw-text-neutral-800 mtop5 tw-flex tw-items-center tw-justify-between">
                                <div class="tw-font-medium tw-inline-flex text-neutral-600 tw-items-center mr-2">
                                    <?= $money_icon; ?>
                                    <span class="tw-ml-1"><?= _l('fq_saas_total_revenue_paid'); ?></span>
                                </div>
                ...
                <div class="col-md-7">
                    ...
                    <p class="text-center"><?= _l('fq_saas_dashboard_package_invoice_stats'); ?></p>
                </div>
            </div>
        </div>
    </div>
