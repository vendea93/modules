...
$cycle_period = _l('fq_saas_billing_cycle');
$yes_no_options = $this->fq_saas_model->yes_no_options();
$select_attr = ['multiple' => 'true', 'allow_blank' => 'true', 'class' => 'selectpicker display-block', 'data-actions-box' => 'true', 'data-width' => '100%'];
$single_pricing_mode = fq_saas_is_single_package_mode();
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h4
                    ...
                    <span>
                        <?= isset($package) ? $package->name : _l('fq_saas_new_package'); ?>
                    </span>
                </h4>
                <?php endif; ?>
                    ...
                    <div class="col-lg-7">
                        <div class="panel_s">
                            <div class="panel-body">
                                ...
                                <?= render_textarea('description', 'fq_saas_description', $value, [], [], 'tinymce tinymce-manual'); ?>

                                <?php endif; ?>

                                <?php $value = (isset($package) ? $package->price : ''); ?>
                                <?= render_input('price', _l('fq_saas_base_price') . ' (' . $currency->name . ')', $value, 'number', ['min' => 0, 'step' => '0.01']); ?>

                                <?php $value = (isset($package) ? $package->trial_period : ''); ?>
                                <?= render_input('trial_period', 'fq_saas_trial_period', $value, 'number', ['step' => '1']); ?>
                                ...
                                <div class="tw-mt-8 tw-mb-8  tw-pt-3">
                                    ...
                                    <div class="form-group select-placeholder">
                                        <div class="tw-flex tw-justify-between">
                                            <label for="recurring" class="control-label">
                                                ...
                                                <?= _l('fq_saas_invoice_add_edit_recurring'); ?>
                                            </label>
                                            <label for="lifetime" class="control-label tw-flex">
                                                <?= _l('fq_saas_mark_as_lifetime'); ?>
                                    ...
                                    <div
                                        ...
                                        <label for="allowed_payment_modes"
                                            class="control-label"><?= _l('fq_saas_package_allowed_payment_modes'); ?></label>
                                        <?php
                                ...
                                <div class="tw-mt-8 tw-mb-8 tw-pt-3">
                                    ...
                                    <?php $client_themes = [
                                        ['key' => 'agency', 'label' => _l('fq_saas_package_client_theme_agency')],
                                        ['key' => 'single', 'label' => _l('fq_saas_package_client_theme_single')],
                                    ]; ?>
                                    <?= render_select('metadata[client_theme]', $client_themes, ['key', ['label']], _l('fq_saas_package_client_theme') . fq_saas_form_label_hint('fq_saas_package_client_theme_hint'), $value, [], [], '', '', false); ?>
                                </div>
                                ...
                                <div class="row tw-mt-8 tw-mb-8  tw-pt-3">
                                    <div class="col-sm-6 col-md-3">
                                        ...
                                        <div class="checkbox checkbox-inline form-group" data-toggle="tooltip"
                                            data-title="<?= _l('fq_saas_enabled_hint'); ?>">
                                            <input type="checkbox" value="1" name="status" <?= $checked ?>>
                                            <label for="ts_rel_to_project"><?= _l('fq_saas_enabled?'); ?></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 col-md-3">
                                        ...
                                        <div class="checkbox checkbox-inline form-group" data-toggle="tooltip"
                                            data-title="<?= _l('fq_saas_is_default_hint'); ?>">
                                            <input type="checkbox" value="1" name="is_default" <?= $checked ?>>
                                            <label for="ts_rel_to_project"><?= _l('fq_saas_is_default'); ?></label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6 col-md-3">
                                        ...
                                        <div class="checkbox checkbox-inline form-group" data-toggle="tooltip"
                                            data-title="<?= _l('fq_saas_is_private_hint'); ?>">
                                            <input type="checkbox" value="1" name="is_private" <?= $checked ?>>
                                            <label for="ts_rel_to_project"><?= _l('fq_saas_is_private'); ?></label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tw-mt-8 tw-mb-8 tw-pt-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mtop10 border-right">
                                            <span><?= _l('fq_saas_enable_subdomain') . fq_saas_form_label_hint('fq_saas_enable_subdomain_hint'); ?></span>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mtop10 border-right">
                                            <span><?= _l('fq_saas_enable_custom_domain') . fq_saas_form_label_hint('fq_saas_enable_custom_domain_hint'); ?></span>
                                        </div>
                                        <div class="col-md-6 mtop10">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mtop10 border-right">
                                            <span><?= _l('fq_saas_autoapprove_custom_domain') . fq_saas_form_label_hint('fq_saas_autoapprove_custom_domain_hint'); ?></span>
                                        </div>
                                        <div class="col-md-6 mtop10">
                                ...
                                <div class="tw-mt-8 tw-mb-8">
                                    ...
                                    <?php $modules = $this->fq_saas_model->modules(); ?>
                                    <?= fq_saas_render_select('modules[]', $modules, ['system_name', ['custom_name']], 'modules', $selected, $select_attr); ?>
                                </div>
                                ...
                                <div class="tw-mt-8 tw-mb-8">
                                    ...
                                    <?php $display_options = array_merge([
                                        ["label" => _l("fq_saas_package_display_yes_4"), "key" => "yes_4"],
                                    ], $yes_no_options); ?>
                                    <?= render_select('metadata[show_modules_list]', $display_options, ['key', ['label']], 'fq_saas_show_modules_list', $selected); ?>
                                </div>

                                <div class="tw-mt-8 tw-mb-8">
                                    <?php $selected = (!empty($package->metadata->show_limits_on_package) ? $package->metadata->show_limits_on_package : 'yes_3'); ?>
                                    <?php $display_options = array_merge([
                                        ["label" => _l("fq_saas_package_display_yes_2"), "key" => "yes_2"],
                                        ["label" => _l("fq_saas_package_display_yes_3"), "key" => "yes_3"],
                                        ["label" => _l("fq_saas_package_display_yes_4"), "key" => "yes_4"],
                                    ], $yes_no_options); ?>
                                    <?= render_select('metadata[show_limits_on_package]', $display_options, ['key', ['label']], 'fq_saas_show_limits_on_package', $selected); ?>
                                </div>

                                <!-- disabled default modules -->
                                <div class="tw-mt-8 tw-mb-8">
                                    <?php $selected = $package->metadata->disabled_default_modules ?? ''; ?>
                                    <?php $default_modules = $this->fq_saas_model->default_modules(); ?>
                                    <?php $label =  _l('fq_saas_disabled_default_modules') . fq_saas_form_label_hint('fq_saas_disabled_default_modules_hint'); ?>
                                    <?= fq_saas_render_select('metadata[disabled_default_modules][]', $default_modules, ['system_name', ['custom_name']], $label, $selected, $select_attr); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel_s">
                            <div class="panel-body">
                                ...
                                <h4 class="tw-mb-4">
                                    <?= _l('fq_saas_modules_price_per_cycle', $cycle_period); ?>
                                </h4>
                                <p><?= _l('fq_saas_modules_price_per_cycle_hint'); ?></p>
                                ...
                                <div class="row form-group tw-flex tw-items-center tw-mb-2"
                                    ...
                                    <div class="col-md-4" data-toggle="tooltip"
                                        data-title="<?= _l('fq_saas_select_an_option'); ?>">
                        ...
                        <!-- Services pricing -->
                        <?php $services = $this->fq_saas_model->services(); ?>
                        <div class="panel_s">
                            <div class="panel-body">

                                <h4 class="tw-mb-4">
                                    <?= _l('fq_saas_services_price_per_cycle', $cycle_period); ?>
                                </h4>
                                <p><?= _l('fq_saas_services_price_per_cycle_hint'); ?></p>
                                <div class="mtop15"></div>
                                <div class="row form-group tw-flex tw-items-center tw-mb-2"
                    ...
                    <div class="col-lg-5">
                        <div class="panel_s">
                            <div class="panel-body">
                                ...
                                <div class="tw-mt-4 tw-mb-8">
                                    ...
                                    <?= render_input('metadata[max_instance_limit]', _l('fq_saas_instance_cap') . fq_saas_form_label_hint('fq_saas_instance_cap_hint'), $value, 'number', ['step' => '1']); ?>

                                    <?php $value = $package->metadata->limitations_unit_price->{'tenant_instance'} ?? ''; ?>
                                    <?= render_input('metadata[limitations_unit_price][tenant_instance]', _l('fq_saas_instance_unit_price') . ' (' . $currency->name . ')' . fq_saas_form_label_hint('fq_saas_instance_unit_price_hint'), $value, 'number', ['min' => 0, 'step' => '0.01']); ?>
                                </div>

                                <!-- Limitations -->
                                <h4 class="tw-mb-4">
                                    <?= _l('fq_saas_limitations_package') . ' ' . fq_saas_form_label_hint('fq_saas_limitations_package_hint'); ?>

                                </h4>
                                <div>
                                    <?php $limit = $package->metadata->resource_limit_period ?? 'lifetime'; ?>
                                    <?= render_select('metadata[resource_limit_period]', [
                                        ['key' => 'lifetime', 'label' => _l('fq_saas_lifetime')],
                                        ['key' => 'billing_cycle', 'label' => _l('fq_saas_billing_cycle')],
                                    ], ['key', ['label']], _l('fq_saas_resources_limit_period') . fq_saas_form_label_hint('fq_saas_resoures_limit_period_hint'), $limit); ?>
                                </div>
                                ...
                                <div class="row" id="package-qouta">
                                    ...
                                    <?php foreach (FQ_SAAS_LIMIT_FILTERS_TABLES_MAP as $event => $limit) : ?>
                                    <div class="col-md-6 col-xs-12 tw-mb-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span
                                                    class="input-group-addon tw-px-2 tw-border-r-0"><?= _l('fq_saas_limit'); ?></span>
                                                ...
                                                <span class="input-group-addon tw-px-2 tw-border-l-0">
                                                    ...
                                                    <a href="#metered" class="mark_metered" data-toggle="tooltip"
                                                        data-title="<?= _l('fq_saas_mark_limited'); ?>"
                                                    ...
                                                    <a href="#infinity" class="mark_infinity" data-toggle="tooltip"
                                                        data-title="<?= _l('fq_saas_mark_unlimited'); ?>"
                                                        onclick="return false;"
                                                        style="<?= $unlimited ? 'display:none' : ''; ?>">
                                            ...
                                            <div class="input-group" data-toggle="tooltip"
                                                data-title="<?= _l('fq_saas_limit_extra_hint', $cycle_period); ?>">
                                                <span
                                                    class="input-group-addon tw-px-2 tw-border-r-0"><?= _l('fq_saas_limit_extra'); ?></span>
                                    ...
                                    <div class="col-md-6 col-xs-12">
                                        ...
                                        $units = fq_saas_storage_size_units();
                                        $value_unit = (isset($package->metadata->storage_limit->unit) ? $package->metadata->storage_limit->unit : $units[0]);
                                        $hidden_quota_widgets_options[] = ['label' => _l('fq_saas_limit_storage'), 'key' => 'storage'];
                                        ?>
                                        <div class="form-group">
                                            <label for="<?= $limit; ?>" class="control-label tw-justify-start">
                                                <span>
                                                    <?php echo _l('fq_saas_limit_storage'); ?><?php echo fq_saas_form_label_hint('fq_saas_limit_storage_hint', $cycle_period); ?>
                                                </span>
                                            </label>
                                            <div class="input-group">
                                                <span
                                ...
                                <div class="row">
                                    <div class="col-md-12 mtop10 col-xs-12">
                                        ...
                                        <?= render_select('metadata[dashboard_quota_visibility]', [
                                            ['key' => 'yes', 'label' => _l('fq_saas_quota_display_all')],
                                            ['key' => 'limited-only', 'label' => _l('fq_saas_quota_display_limited_only')],
                                            ['key' => 'no', 'label' => _l('fq_saas_quota_display_no')],
                                            ['key' => 'no-for-all', 'label' => _l('fq_saas_quota_display_no_for_all')]
                                        ], ['key', ['label']], 'fq_saas_tenant_dashboard_quota_visibility', $quota_display); ?>
                                    </div>

                                    <div class="col-md-12 mtop10 col-xs-12">
                                        <?php $hidden_quota_widgets = isset($package->metadata->hidden_quota_widgets) ? $package->metadata->hidden_quota_widgets : []; ?>
                                        <?= fq_saas_render_select('metadata[hidden_quota_widgets][]', $hidden_quota_widgets_options, ['key', ['label']], 'fq_saas_tenant_hidden_quota_widgets', $hidden_quota_widgets, $select_attr); ?>
                                    </div>
                        ...
                        <div class="panel_s">
                            <div class="panel-body">
                                ...
                                <h4 class="tw-mb-4">
                                    <?= _l('fq_saas_tabs_visibility_control'); ?>
                                </h4>
                                <p><?= _l('fq_saas_tabs_visibility_control_hint'); ?></p>
                                <div class="mtop15"></div>
                                <hr />

                                <?php
                                foreach (fq_saas_app_tabs_group() as $group) :
                                    $selected = $package->metadata->hidden_app_tabs->{$group} ?? [];
                                ?>
                                <div class="form-group">
                                    <label
                                        for="hide-tab-<?= $group; ?>"><?= _l('fq_saas_tabs_group_' . $group); ?></label>
                                    ...
                                    <select name="metadata[hidden_app_tabs][<?= $group; ?>][]"
                                        ...
                                        <?php
                                            ...
                                            if ($group === 'settings' && method_exists($this->app, 'get_settings_sections')) {
                                                $children = fq_saas_app_settings_tabs();
                                            }

                                            foreach ($children as $key => $value) :
                                                $slug = $value['slug'];
                                                if (stripos($slug, FQ_SAAS_MODULE_NAME) !== false) continue;
                                            ?>
                    ...
                    <div class="col-lg-<?= $single_pricing_mode ? '7' : '5'; ?>" id="discounts">
                        <div class="panel_s">
                            <div class="panel-body">
                                ...
                                <h4 class="tw-mb-4">
                                    <?= _l('fq_saas_pricing_discounts'); ?>
                                </h4>
                                <p><?= _l('fq_saas_pricing_discounts_hint'); ?></p>
                                <div class="mtop15"></div>
                                <div class="tw-flex tw-items-center tw-justify-between tw-mb-2"
                                    ...
                                    <div class="col-md-4" data-toggle="tooltip"
                                        ...
                                        <select class="form-control tw-p-1"
                                            ...
                                            <option value="tenant_instance">
                                                <?= _l('fq_saas_limit_tenant_instance'); ?>
                                            </option>
                                            <option value="storage"><?= _l('fq_saas_limit_storage'); ?></option>

                                            <?php foreach (FQ_SAAS_LIMIT_FILTERS_TABLES_MAP as $event => $limit) : ?>
                                            <option value="<?= $limit; ?>"><?= _l('fq_saas_limit_' . $limit); ?>
                                            </option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    <div class="col-md-3" data-toggle="tooltip"
                                        data-title="<?= _l('fq_saas_minimum_unit'); ?>">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group" data-class="col-md-3" data-toggle="tooltip"
                                            data-title="<?= _l('fq_saas_discount_percent'); ?>">
                                            <input type="number" step="0.01" min="1" class="form-control tw-p-1"
                    ...
                    <div class="col-md-12">
                        <div class="panel_s">
                            <div class="panel-body">
                                ...
                                <?php $db_schemes = $this->fq_saas_model->db_schemes(); ?>
                                <?= render_select('db_scheme', $db_schemes, ['key', ['label']], 'fq_saas_db_scheme', $value, [], [], '', '', false); ?>

                                <!-- DB pools -->
                                <div
                                    class="form-group tw-mt-10 tw-mb-8 db_pools <?= in_array($value, ['shard', 'single_pool']) ? '' : 'hidden'; ?>">
                                    <label><?= _l('fq_saas_db_pools'); ?></label>
                                    <div class="tw-flex tw-items-center tw-mt-4 tw-justify-center">
                                        <div class="tw-flex tw-space-x-2 pool-template tw-items-center">
                                            <?= render_input('db_pools[host][]', 'fq_saas_db_host', '', 'text', ['placeholder' => 'localhost']); ?>
                                            <?= render_input('db_pools[user][]', 'fq_saas_db_user', '', 'text', ['placeholder' => 'root']); ?>
                                            <?= render_input('db_pools[password][]', 'fq_saas_db_password', '', 'text', ['placeholder' => 'password']); ?>
                                            <?= render_input('db_pools[dbname][]', 'fq_saas_db_name', ''); ?>
                                        </div>
                                ...
                                <div class="advance-settings hidden">
                                    ...
                                    <div class="tw-mt-10 tw-mb-10">
                                        ...
                                        <?php $options = $this->fq_saas_model->shared_options(); ?>

                                        <label for="sharedfilter"><?= _l('fq_saas_package_shared_settings'); ?>
                                            <span data-toggle="tooltip"
                                                data-title="<?= _l('fq_saas_package_shared_settings_hint'); ?>"><i
                                                    class="fa fa-question-circle"></i></span></label>
                                        <input id="sharedfilter" type="text" class="form-control tw-mb-2"
                                            placeholder="<?= _l('fq_saas_filter_shared_settings'); ?>" />
                                    ...
                                    <?= render_select('metadata[allow_customization]', $yes_no_options, ['key', ['label']], 'fq_saas_allow_package_customization', $selected); ?>

                                    <!-- disable module marketplace -->
                                    <?php $selected = $package->metadata->disable_module_marketplace ?? 'no'; ?>
                                    <?= render_select('metadata[disable_module_marketplace]', $yes_no_options, ['key', ['label']], 'fq_saas_disable_module_marketplace_for_package', $selected); ?>

                                    <!-- disable service marketplace -->
                                    <?php $selected = $package->metadata->disable_service_marketplace ?? 'no'; ?>
                                    <?= render_select('metadata[disable_service_marketplace]', $yes_no_options, ['key', ['label']], 'fq_saas_disable_service_marketplace_for_package', $selected); ?>

                                    <!-- assigned client ids -->
                                    <?php
                                    $selected = $package->metadata->assigned_clients ?? [];
                                    if (is_string($selected)) $selected = json_decode($selected);
                                    $this->load->view('includes/client_select', ['name' => 'metadata[assigned_clients][]', 'label' => fq_saas_input_label_with_hint('fq_saas_package_assigned_clients'), 'value' => $selected]);
                                    ?>
                                    ...
                                    <?= render_input('slug', 'fq_saas_slug', $value); ?>
                                    <?php endif ?>
                                    ...
                                    <?= render_input('metadata[priority]', _l('fq_saas_package_priority'), $value, 'number', ['min' => 0, 'step' => '1']); ?>


                                    <!-- Custom tenant seed source -->
                                    <div class="form-group">
                                        <label for="w-full">
                                            <?php $key = 'fq_saas_tenant_seeding_source'; ?>
                                            <?= fq_saas_input_label_with_hint($key, $key . '_hint'); ?>
                                        </label>
                                        <?php $seeding_tenant_slug = $package->metadata->seeding_tenant ?? ''; ?>
                                        <?php $this->load->view(FQ_SAAS_MODULE_NAME . '/includes/tenant_select', ['name' => 'metadata[seeding_tenant]', 'value' => $seeding_tenant_slug]); ?>
                                        <small
                                            class="text text-warning"><?= _l('fq_saas_tenant_seeding_source_package_note'); ?></small>
                                    </div>
                                    <div class="tw-mt-4 tw-mb-4">
                                        <hr />
                                    </div>
                                    ...
                                    <?= render_select('metadata[auto_remove_inactive_instance]', $yes_no_options, ['key', ['label']], _l('fq_saas_auto_remove_inactive_instance'), $selected); ?>

                                    <div class="auto_remove_inactive_instance deps">
                                        <?= render_input('metadata[auto_remove_inactive_instance_days]', _l('fq_saas_auto_remove_inactive_instance_days') . ' ' . fq_saas_form_label_hint('fq_saas_auto_remove_inactive_instance_days_hint'), $package->metadata->auto_remove_inactive_instance_days_hint ?? 30, 'number', ['min' => FQ_SAAS_MINIMUM_AUTO_INSTANCE_REMOVE_GRACE_PERIOD]); ?>
                                    </div>
                                </div>

                                <div class="text-right">
                                    <button type="submit" data-loading-text="<?= _l('fq_saas_saving...'); ?>"
                                        data-form="#packages_form" class="btn btn-primary mtop15
                                    mbot15"><?= _l('fq_saas_submit'); ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
