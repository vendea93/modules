                    ...
                    <div class="panel-body">
                        <div class="row mtop25 tw-mb-4">
                            <div class="col-md-6 border-right">
                                <span><?php echo fq_saas_input_label_with_hint('fq_saas_stripe_subscription_enabled') ?></span>
                            </div>
                            <div class="col-md-2">
                        ...
                        <div class="row mtop25 tw-mb-4 enable-deps">
                            <div class="col-md-6 border-right">
                                <span><?php echo fq_saas_input_label_with_hint('fq_saas_stripe_autosync_enabled') ?></span>
                            </div>
                            <div class="col-md-2">
                                <div class="onoffswitch">
                ...
                <div class="panel_s enable-deps">
                    <div class="panel-body">
                        <div class="form-group select-placeholder pricing sync-deps">
                            <label><?= _l('fq_saas_base_price'); ?></label>
                        ...
                        $proration_behavior_options = [
                            [
                                'key' => 'always_invoice',
                                'label' => _l('fq_saas_stripe_prorate_always_invoice')
                            ],
                            [
                                'key' => 'create_prorations',
                                'label' => _l('fq_saas_stripe_prorate_create_prorations')
                            ],
                            [
                                'key' => 'none',
                                'label' => _l('fq_saas_stripe_prorate_none')
                            ],
                        ];
                        $selected = (!empty($package_stripe_settings->proration_behavior) ? $package_stripe_settings->proration_behavior : 'none');
                        echo render_select('metadata[stripe][proration_behavior]', $proration_behavior_options, ['key', ['label']], _l('fq_saas_stripe_prorate') . '<a
                        ...
                        <?php
                        $value = ($package_stripe_settings->terms ?? '');
                        // Stripe truncates Terms/Metadata-like free-form text fields at around 500 characters.
                        // Enforce the limit both visually (maxlength) and semantically via a small helper below.
                        $terms_maxlength = 500;
                        ?>
                        <?php echo render_textarea('metadata[stripe][terms]', 'terms_and_conditions', $value, ['placeholder' => _l('subscriptions_terms_info'), 'id' => 'terms_' . $package->slug, 'maxlength' => $terms_maxlength, 'data-terms-max' => $terms_maxlength], [], '', 'ays-ignore'); ?>
                        <div class="tw-text-xs tw-text-neutral-500 tw-mt-1">
                            <span id="terms_counter_<?= $package->slug; ?>"><?= mb_strlen((string) $value); ?></span> / <?= $terms_maxlength; ?>
                        </div>
                        <script>
                            (function () {
                                var ta = document.getElementById('terms_<?= $package->slug; ?>');
                                var counter = document.getElementById('terms_counter_<?= $package->slug; ?>');
                                if (!ta || !counter) return;
                                var max = <?= (int) $terms_maxlength; ?>;
                                var render = function () {
                ...
                <div class="pricing sync-deps">
                    ...
                    <div class="panel_s enable-deps">
                        <div class="panel-body">
                            ...
                            <h4 class="tw-mb-4">
                                <?= _l('fq_saas_services_price_per_cycle', ''); ?>
                                (<?= _l('fq_saas_billing_cycle'); ?>)
                            </h4>
                            <div class="mtop15"></div>
                ...
                <div class="panel_s enable-deps">
                    <div class="panel-body">
                        ...
                        <div class="tw-mt-4 tw-mb-8">
                            <div class="form-group select-placeholder">
                                <label><?= _l('fq_saas_instance_unit_price'); ?></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-xs-12 tw-mb-4">
                                ...
                                <div class="form-group select-placeholder">
                                    <label><?php echo _l('fq_saas_limit_' . $limit); ?></label>
                            ...
                            <div class="col-md-6 col-xs-12">
                                ...
                                ?>
                                <div class="form-group select-placeholder">
                                    <label><?php echo _l('fq_saas_limit_storage'); ?></label>
        ...
        <div class="text-center">
            <button type="submit" data-loading-text="<?= _l('fq_saas_saving...'); ?>"
                data-form="#stripe_pricing_form_<?= $package->slug; ?>" class="btn btn-primary mtop15
                                    mbot15"><?= _l('fq_saas_save_stripe_pricing_btn', $package->name); ?></button>
        </div>
        <?= form_close(); ?>
