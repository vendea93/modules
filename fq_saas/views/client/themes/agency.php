    ...
    <div
        ...
        <div
                    ...
                    <div class="tw-flex tw-items-center tw-gap-2 links">
                        ...
                        <div class="tw-flex tw-flex-col  tw-w-full">
                            <a class="tw-mt-8 tw-mb-2 tw-text-ellipsis tw-truncate tw-w-full text-left !tw-max-w-xs"
                                ...
                                data-title="<?= _l('fq_saas_customer_link'); ?>"
                                href="<?= fq_saas_tenant_base_url($company); ?>">
                                <?= fq_saas_tenant_base_url($company); ?> <i class="fa fa-external-link"></i>
                            </a>
                            <a class="tw-mb-8 tw-text-ellipsis tw-truncate tw-w-full text-left !tw-max-w-xs"
                                target="_blank" data-toggle="tooltip" data-title="<?= _l('fq_saas_admin_link'); ?>"
                                href="<?= fq_saas_tenant_admin_url($company); ?>">
                                <?= fq_saas_tenant_admin_url($company); ?>
            ...
            <div class="panel_footer tw-flex tw-justify-between tw-items-center tw-mt-4 tw-mb-3">
                <div data-toggle="tooltip" data-title="<?= _l('fq_saas_date_created'); ?>">
                ...
                <div class="tw-flex tw-space-x-2">
                    ...
                    <button data-toggle="tooltip" data-title="<?= _l('fq_saas_view'); ?>"
