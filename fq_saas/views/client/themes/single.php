...
$company = $tenant;
$deploying = fq_saas_company_status_can_deploy($company);
?>
    ...
    <div class="ps-view tw-mt-8" id="companies">
        ...
        <div class="row tw-flex tw-justify-center tw-flex-wrap  company <?= $company->status; ?> <?= $autolaunch; ?>">
                ...
                <div class="tw-relative">
                    ...
                    <div class="info">
                        ...
                        <div class="menu">
                            ...
                            <button data-toggle="tooltip" data-title="<?= _l('fq_saas_quick_view'); ?>"
            ...
            <div class="col-xs-12 col-md-5 text-center">
                ...
                ?>
                <?php if ($invoice && $invoice->status != '5' && !fq_saas_is_single_package_mode()) : ?>
                <a class="btn btn-primary"
                    href="<?= site_url('clients/?subscription'); ?>"><?= _l('fq_saas_change_plan'); ?></a>
                <?php elseif (!$invoice) : ?>
                <div class="tw-h-full text-center tw-flex tw-items-center">
                    <div class="">
                        <span class="text-danger">
                            <?= _l('fq_saas_no_invoice_client_for_client_mid'); ?>
                        </span>
                        <a class="btn btn-primary tw-mt-8"
                            href="<?= fq_saas_default_base_url('clients/?subscription'); ?>">
                            <?= _l('fq_saas_manage_subscription'); ?>
                        </a>
                    </div>
                </div>
                <?php endif; ?>
        ...
        <div class="iframe-toolbar">
            <div class="tw-flex" id="company-switch">
                <button type="button" class="btn btn-danger close-btn" data-toggle="tooltip"
                    data-title="<?= _l('fq_saas_back_to_client_portal'); ?>" aria-label="Close"
...
<link rel="stylesheet" type="text/css"
    href="<?= module_dir_url(FQ_SAAS_MODULE_NAME, 'assets/css/single-theme.css'); ?>" />
