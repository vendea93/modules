    ...
    (() => {
        ...
        addButtons.forEach((button, index) => {
            button.addEventListener('click', (e) => {
                ...
                const oneTimeTag =
                    '<span data-toggle="tooltip" data-title="<?= fq_saas_ecape_js_attr(_l('fq_saas_service_one_time_payment_hint')); ?>" class="badge bg-warning tw-px-1"><?= fq_saas_ecape_js_attr(_l('fq_saas_service_one_time_payment')); ?></span>';
