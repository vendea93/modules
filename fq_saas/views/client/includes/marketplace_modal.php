            ...
            <div class="modal-header">
                <div class="tw-flex tw-justify-between tw-items-center">
                    ...
                    <button type="button" class="close" data-dismiss="modal"
                        aria-label="<?= fq_saas_ecape_js_attr(_l('close')); ?>">
            ...
            <div class="modal-body">
                <div class="row saas-market-items">
                    ...
                    <?php
                        ...
                        $interval = $billing_mode !== 'lifetime' ? '/' . $billing_cycle : ' <span data-toggle="tooltip" data-title="' . _l('fq_saas_service_one_time_payment_hint') . '" class="badge bg-warning tw-px-1">' . _l('fq_saas_service_one_time_payment') . '</span>';
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div>
                                    ...
                                    <p class="card-text"><?= _l('fq_saas_price'); ?>:
                                ...
                                <div class="tw-flex tw-justify-end">
                                    ...
                                    <small class="btn btn-secondary disabled btn-sm" data-toggle="tooltip"
                                        data-title="<?= fq_saas_ecape_js_attr(_l('fq_saas_module_included_hint')); ?>"
                                        disabled><?= _l('fq_saas_module_included'); ?> <i
                                    ...
                                    <button type="button"
                                        ...
                                        data-confirm="<?= fq_saas_ecape_js_attr(_l('fq_saas_service_one_time_payment_hint')); ?>"
                                        <?php } ?>><?= _l('fq_saas_add'); ?></button>
                                    <button type="button" class="btn btn-danger remove-item" data-key="<?= $item_id; ?>"
                                        ...
                                        style="display: none;"><?= _l('fq_saas_remove'); ?></button>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div>
                                    <h4 class="card-title text-center">
                                        <?= _l('fq_saas_request_' . $modal_type); ?></h4>
                                    <p class="text-center"><?= _l('fq_saas_request_' . $modal_type . '_desc'); ?>
                                    </p>
                                </div>
                                <div class="tw-flex tw-justify-center">
                                    <a href="<?= $request_url; ?>" target="_blank"
                                        class="btn btn-info btn-full"><?= _l('fq_saas_request_' . $modal_type . '_btn'); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
