...
trait FqSaasMailTemplate
{
    ...
    public function build()
    {
        ...
        $this->ci->load->library(FQ_SAAS_MODULE_NAME . '/merge_fields/fq_saas_company_merge_fields');
        ...
        $this->to($this->contact_email)                                // Set the recipient email address
            ...
            ->set_merge_fields('fq_saas_company_merge_fields', $this->instance_data, $this->other_extra_data);   // Set merge fields for Perfex SaaS company
    }
}
