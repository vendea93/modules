...
<div id="wrapper" >
    <div class="content">
        <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <?php echo form_open_multipart(admin_url('workshop/add_edit_mechanic'), array('id' => 'add_edit_mechanic')); ?>
                                ...
                                <div role="tabpanel" class="tab-pane active" id="tab_staff_profile">
                                    ...
                                    <?php if(total_rows(db_prefix().'emailtemplates',array('slug'=>'two-factor-authentication','active'=>0)) == 0){ ?>
                                        ...
                                        if(isset($staff_cover_image) && $staff_cover_image != false){
                                            $link_cover_image = 'uploads/staff_profile_images/' . $mechanic->staffid . '/thumb_'.$mechanic->profile_image;
                                        ...
                                        <div class="col-md-12">  
                                            <div class="picture-container pull-left">
                                                <div class="picture pull-left">
                                                    <img src="<?php if(isset($staff_cover_image) && isset($image_exist) && isset($link_cover_image)){ echo  base_url($link_cover_image); }else{  echo site_url('modules/workshop/uploads/none_avatar.jpg'); } ?>" class="picture-src" id="wizardPicturePreview" title="">
                                    ...
                                    <div class="modal-footer">
                                        <a href="<?php echo admin_url('workshop/mechanics'); ?>"  class="btn btn-default mr-2 "><?php echo _l('close'); ?></a>
            ...
            require('modules/workshop/assets/js/mechanics/add_mechanic_js.php');
            ?>
        </body>
        </html>