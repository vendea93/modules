...
class Receipt_report_80_pdf extends App_pdf
{
	...
	public function __construct($repair_job_label, $tag = '')
	{
		...
		$GLOBALS['receipt_report_80_pdf'] = $repair_job_label;
	...
	{
		$actualPath = APP_MODULES_PATH . '/workshop/views/repair_jobs/print_reports/receipt_report_80_pdf.php';
		return $actualPath;
	}
