    ...
    $.widget("jHtree.jHTree", {
        ...
        _interactionEvents: function () {
            ...
            $(".tree").on("click", ".trcont > .ui-widget-header", function () {
                ...
                // $.post(admin_url+'okr/get_not_child',data).done(function(response){
                //    response = JSON.parse(response);
                //     $("#tree_clone")._create({
                //        callType: 'obj',
                //        structureObj: response,
                //        zoomer: true
                //     });
                //     $("#myModal2").modal();
                // });
        ...
        _zoomer: function (treeDiv) {
            var zmr = '<div class="zmrcntr hide"><input type="text" id="zmrval" class="zomrval hide"><div id="zmrslidr" style="height:200px;"></div></div>';
