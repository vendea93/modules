...
<div class="modal fade poly_utilities_modal_add" id="poly_utilities_add_proposal" tabindex="-1" role="dialog" data-backdrop="static">
    <div class="modal-dialog poly_utilities-setup-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">
                    <span class="add-title"><?php echo _l('poly_utilities_modal_header_proposal') ?></span>
                </h4>
            </div>
            <div class="modal-body poly_utilities_modal_form">

                <div class="accounting-template proposal">
                    <div class="row">
                        <?php
                        $rel_type  = 'customer';
                        $rel_id = $project->clientid;
                        $rel_data = get_relation_data('customer', $rel_id);
                        $client_info  = get_relation_values($rel_data, 'customer');
                        ?>
                        <?php
                        echo form_open(admin_url('poly_utilities/add_proposal'), ['id' => 'poly_utilities_proposal_form', 'class' => '_transaction_form proposal-form']);
                        ?>
                        ...
                        <div class="col-md-12">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-6 border-right">
                                            ...
                                            <?php echo render_input('subject', 'proposal_subject', '', 'text', $attrs); ?>
                                            <div class="form-group">
                                                <label for="rel_type" class="control-label"><?php echo _l('proposal_related'); ?></label>
                                                <input type="hidden" class="form-control" name="rel_type" id="rel_type" value="<?php echo $rel_type ?>">
                                                <input type="text" class="form-control" value="<?php echo $rel_type ?>" disabled>
                                            </div>

                                            <div class="form-group">
                                                <label for="rel_id"><span class="rel_id_label"><?php echo _l('estimate_request_for_customer'); ?></span></label>
                                                <input type="hidden" class="form-control" name="rel_id" id="rel_id" value="<?php echo $rel_id ?>">
                                                <input type="text" class="form-control" value="<?php echo $client_info['name'] ?>" disabled>
                                            ...
                                            <div class="form-group projects-wrapper">
                                                ...
                                                <div>
                                                    ...
                                                    <input class="form-control" type="text" value='<?php echo '#' . $project->id . ' - ' . $project->name . ' - ' . $client_info['name'] ?>' disabled>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group select-placeholder">
                                                        ...
                                                        <select name="discount_type" class="selectpicker" data-width="100%" data-none-selected-text="<?php echo _l('poly_utilities_dropdown_non_selected_text'); ?>">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group select-placeholder">
                                                        ...
                                                        ?>
                                                        <select name="status" class="selectpicker" data-width="100%" <?php echo e($disabled); ?> data-none-selected-text="<?php echo _l('poly_utilities_dropdown_non_selected_text'); ?>">
                            ...
                            <div class="bottom-transaction text-right sm:tw-flex sm:tw-items-center sm:tw-justify-between">
...
<script>
    ...
    function validate_proposal_form() {
        appValidateForm($('#poly_utilities_proposal_form'), {
            subject: 'required',
