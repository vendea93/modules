<script>
  ...
  $( document ).ready(function() {
      ...
      $('li.menu-item-reputation_expenses').addClass('active');
      $('li.sub-menu-item-reputation_vendors').addClass('active');
      ...
      {
        $( "#dowload_file_sample" ).append( '<a href="'+ site_url+'modules/reputation/uploads/file_sample/Sample_import_vendor_file_vi.xlsx" class="btn btn-primary" ><?php echo _l('download_sample') ?></a><hr>' );

      }else{
        $( "#dowload_file_sample" ).append( '<a href="'+ site_url+'modules/reputation/uploads/file_sample/Sample_import_vendor_file_en.xlsx" class="btn btn-primary" ><?php echo _l('download_sample') ?></a><hr>' );
      }
    });
...
function uploadfilecsv(){
  "use strict";
    ...
    $.ajax({ 
      url: admin_url + 'reputation/import_file_xlsx_vendor', 
      method: 'post', 
      data: formData, 
      contentType: false, 
      processData: false
