<script>
  ...
  $( document ).ready(function() {
      ...
      $('li.sub-menu-item-reputation_topics').addClass('active');
      ...
      {
        $( "#dowload_file_sample" ).append( '<a href="'+ site_url+'modules/reputation/uploads/file_sample/Sample_import_topic_file_vi.xlsx" class="btn btn-primary" ><?php echo _l('download_sample') ?></a><hr>' );

      }else{
        $( "#dowload_file_sample" ).append( '<a href="'+ site_url+'modules/reputation/uploads/file_sample/Sample_import_topic_file_en.xlsx" class="btn btn-primary" ><?php echo _l('download_sample') ?></a><hr>' );
      }
    });
...
function uploadfilecsv(){
  "use strict";
    ...
    $.ajax({ 
      url: admin_url + 'reputation/import_file_xlsx_topic', 
      method: 'post', 
      data: formData, 
      contentType: false, 
      processData: false
