...
.dashboard-percent-positive {
  color: #28a745;
}

.dashboard-percent-negative {
  color: #dc3545;
}

.summary-dashboard-stats {
    display: grid;
    grid-template-columns: repeat(5, 1fr); /* Mỗi dòng có 4 thẻ */
    gap: 20px;
}
...
.stat-card .icon {
    padding: 5px;
  font-size: 32px;
  color: #4CAF50; /* Customize as desired */
}
...
/* Tooltip icon styling - always visible */
.tooltip-icon {
  font-size: 16px;
  color: #999;
}
