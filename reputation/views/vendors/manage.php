            ...
            <div class="panel_s">
               <div class="panel-body backdrop">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <div class="_buttons">
                        <?php if(has_permission('reputation_vendor', '', 'create')){ ?>
                       <a href="<?php echo admin_url('reputation/vendor'); ?>" class="btn btn-info mright5 test pull-left display-block">
                       <?php echo _l('new_vendor'); ?></a>

                       <a href="<?php echo admin_url('reputation/vendor_import'); ?>" class="btn btn-info mright5 test pull-left display-block">
