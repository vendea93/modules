...
<div id="wrapper" class="customer_profile">
   <div class="content">
      <div class="row">
         ...
         <?php if($group == 'profile' && ((isset($client) && has_permission('reputation_vendor', '', 'edit')) || (!isset($client) && has_permission('reputation_vendor', '', 'create'))) ){ ?>
...
<?php require 'modules/reputation/assets/js/vendors/vendor_js.php';?>
