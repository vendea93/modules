...
<div class="modal fade" id="contact" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <?php echo form_open(admin_url('reputation/form_contact/'.$customer_id.'/'.$contactid),array('id'=>'contact-form','autocomplete'=>'off')); ?>
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel"><?php echo e($title); ?><br /><small class="color-white" id=""><?php echo rep_get_vendor_company_name($customer_id,true); ?></small></h4>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="alert alert-warning hide" role="alert" id="contact_proposal_warning">
                            ...
                            <hr />
                            <a href="#" id="contact_update_proposals_emails" data-original-email="" onclick="update_all_proposal_emails_linked_to_contact(<?php echo e($contact->id); ?>); return false;"><?php echo _l('update_proposal_email_yes'); ?></a>
                            <br />
...
<?php if(!isset($contact)){ ?>
    <?php require 'modules/reputation/assets/js/vendors/contact_js.php';?>
<?php } ?>
