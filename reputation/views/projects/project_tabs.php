...
<div class="horizontal-scrollable-tabs tw-bg-white tw-shadow-sm tw-rounded-lg tw-px-3 tw-min-h-0">
    ...
    <div class="horizontal-tabs">
        ...
        foreach ($tabs as $key => $tab) {
            ...
            <li class="<?php if ($tab['key'] == 'keywords' && !$this->input->get('group')) {
                echo 'active ';
            } ?>project_tab_<?php echo e($tab['key']); ?><?php if ($dropdown) {
                echo ' nav-tabs-submenu-parent';
            } ?> tw-py-2">
                <a data-group="<?php echo e($tab['key']); ?>" role="tab" <?php if ($dropdown) { ?> data-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="true" class="dropdown-toggle" href="#"
                    id="dropdown_<?php echo e($tab['key']); ?>" <?php } else { ?>
                    href="<?php echo admin_url('reputation/project/' . $project->id . '?group=' . $tab['key']); ?>" <?php } ?>>
                ...
                <div class="tabs-submenu-wrapper">
                    <?php } ?>
                    <ul class="dropdown-menu" aria-labelledby="dropdown_<?php echo e($tab['key']); ?>">
                        <?php
